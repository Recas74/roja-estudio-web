...
function response_page(bool $success, string $message): void {
    ...
    echo '<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>' . $title . ' | ROJA Estudio</title><meta name="robots" content="noindex,nofollow"><link rel="icon" href="/assets/brand/roja-rj-separado.svg" type="image/svg+xml"><link rel="icon" href="/favicon-48.png" type="image/png" sizes="48x48"><link rel="shortcut icon" href="/favicon.ico"><link rel="stylesheet" href="/styles.css?v=20260818-4"></head><body><main class="form-response"><a class="brand" href="/"><img src="/assets/brand/roja-logo-horizontal-rj-separado-dark.svg" alt="ROJA Estudio"></a><section><p class="eyebrow">' . $label . '</p><h1>' . $title . '.</h1><p>' . $safeMessage . '</p><div class="hero-actions"><a class="button button-dark" href="/">Volver a la web</a><a class="text-link" href="mailto:info@rojaestudio.es">info@rojaestudio.es <span>↗</span></a></div></section></main></body></html>';
    exit;
}
